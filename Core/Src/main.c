...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
// les rows sont des output et les columns sont des input
#define R1_PORT GPIOA // row 1
#define R1_PIN GPIO_PIN_7 // output declaré
...
{ // toujours faire une condition sur seul row et seul colonne : si les deux sont low alors c"est ca la bouton pressée
